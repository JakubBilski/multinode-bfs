...
{
	printf("usage:\t mybfs\t file_mtx\t output_file\t number_of_tests\t solution1\t [solution2 ...]\n");
	printf("  file_mtx - path to the graph file in the Matrix Market format\n");
	printf("  output_file - path to the csv output\n");
